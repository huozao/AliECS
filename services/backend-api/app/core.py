...
DEFAULT_FEATURES: list[dict[str, Any]] = [
    ...
    {"id": 16, "code": "formula_color_space", "title": "配方色彩空间", "description": "探索配方在不同树脂和添加比例下的实测 Lab 颜色与色差轨迹", "url": "/formula/colors/", "category": "业务查询", "required_permission": "formula.read", "status": "active", "sort_order": 34},
    {"id": 15, "code": "tplus_bom_builder", "title": "新建 T+ BOM", "description": "选择已有父件和子件并提交物料清单", "url": "/bom-builder/", "category": "业务录入", "required_permission": "tplus.bom.write", "status": "active", "sort_order": 35},
