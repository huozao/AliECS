...
After frontend edits, also verify browser behavior against `http://localhost:8080` when the local stack is running. At minimum check page load, login button/modal, recipe query panel visibility, and no console syntax errors.
