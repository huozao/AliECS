...
class EnvWiringTests(unittest.TestCase):
    def test_compose_maps_feishu_and_receive_id(self) -> None:
        ...
        for key in ("VERSION_DIGEST_FEISHU_APP_ID:", "VERSION_DIGEST_FEISHU_APP_SECRET:",
                    "VERSION_DIGEST_FEISHU_RECEIVE_ID:", "GOLD_SPREAD_ALERT_TOKEN:",
                    "GOLD_SPREAD_FEISHU_RECEIVE_ID:",
                    "GOLD_SPREAD_OPS_FEISHU_RECEIVE_ID:"):
            self.assertIn(key, c)
