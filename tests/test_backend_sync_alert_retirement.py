...
class BackendSyncAlertRetirementTests(unittest.TestCase):
    ...
    def test_default_worker_invokes_unified_notifier(self) -> None:
        ...
        with (
            ...
            mock.patch.object(worker_loop, "run_enqueue_daily_structure_backup_jobs", return_value=0),
            mock.patch.object(worker_loop, "run_pending_structure_backup_jobs", return_value=0),
