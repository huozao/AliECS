...
: "${WEBDOCK_FAILOVER_LEDGER_PATH:=/var/lib/webdock-failover-proxy/requests.sqlite3}"
: "${WEBDOCK_FAILOVER_LEDGER_RETENTION_SECONDS:=604800}"
...
WEBDOCK_FAILOVER_LEDGER_PATH=${WEBDOCK_FAILOVER_LEDGER_PATH}
WEBDOCK_FAILOVER_LEDGER_RETENTION_SECONDS=${WEBDOCK_FAILOVER_LEDGER_RETENTION_SECONDS}
ENV
